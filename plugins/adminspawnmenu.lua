...
if (SERVER) then
    ...
    ix.log.AddType("adminSpawnItemLog", function(client, name) return string.format("%s has spawned \"%s\"", client:GetCharacter():GetName(), tostring(name)) end)
